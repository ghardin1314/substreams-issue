use crate::abi;
use crate::pb::safe::v1::SafeReceived;
use crate::pb::{
...
fn map(event: abi::GnosisSafeL2::events::SafeReceived) -> safe_event::Event {
    safe_event::Event::SafeReceived(SafeReceived {
